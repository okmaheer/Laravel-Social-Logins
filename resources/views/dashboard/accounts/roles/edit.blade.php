        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::model($model, ['route' => ['dashboard.accounts.roles.update', $model->id], 'method' => 'PUT', 'files' => true, 'class' => 'solid-validation'] ) !!}
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    @foreach($modelPermissions as $permission)
                                        <div class="col-md-4">
                                            <div class="checkbox my-2">
                                                <div class="custom-control custom-checkbox">
                                                    {!! Form::checkbox('permissions[]', $permission->id, $rolePermissions->contains($permission->id) ? true : false, ['id' => $permission->name, 'class' => 'custom-control-input' ]) !!}
